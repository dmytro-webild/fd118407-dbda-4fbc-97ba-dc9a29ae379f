...
export const metadata: Metadata = {
  title: "Professional Web Design & Digital Marketing | ",  description: "Attract more clients with professional web design that ranks on Google. We build websites that convert visitors into leads and get your phone ringing.",  keywords: "web design, digital marketing, SEO services, lead generation, professional website design",  metadataBase: new URL("https://proofdigital.com"),
  alternates: {
    canonical: "https://proofdigital.com"
  },
  openGraph: {
    title: "Professional Web Design & Digital Marketing | ",    description: "Attract more clients with professional web design that ranks on Google. Get more calls and leads today.",    url: "https://proofdigital.com",    siteName: "",    type: "website"
  },
  twitter: {
    card: "summary_large_image",    title: "Professional Web Design & Digital Marketing | ",    description: "Professional websites that attract clients, rank on Google, and generate qualified leads."
  },
  robots: {
    index: true,
    follow: true
